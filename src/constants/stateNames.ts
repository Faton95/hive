...
export const OUTSOURCE_LIST = 'outsourceList'
export const OUTSOURCE_ITEM = 'outsourceItem'
export const OUTSOURCE_CREATE = 'outsourceCreate'
export const OUTSOURCE_UPDATE = 'outsourceUpdate'
export const OUTSOURCE_DELETE = 'outsourceDelete'
